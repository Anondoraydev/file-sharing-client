    ...
    return (
        <div>
            <svg width="12%" height="12%" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M3.48544 37.0792C2.16397 35.8511 1.14739 34.3 0.56108 32.5426C0.459551 32.2382 0.375253 31.921 0.307173 31.5803L13.3239 26.0458L3.48544 37.0792Z" fill="#FF1616" data-darkreader-inline-fill="" className="--darkreader-inline-fill: var(--darkreader-text-ff1616, #ff0000);"></path>
                <path d="M40 24.6183C40 25.7428 39.9968 26.7154 39.9858 27.5692L28.1729 23.006H40V24.6183Z" fill="#FF1616" data-darkreader-inline-fill="" className="--darkreader-inline-fill: var(--darkreader-text-ff1616, #ff0000);"></path>
                <path d="M11.5962 23.006L0.0106534 27.4805C0.000706106 26.6481 0 25.704 0 24.6183V23.006H11.5962Z" fill="#FF1616" data-darkreader-inline-fill="" className="--darkreader-inline-fill: var(--darkreader-text-ff1616, #ff0000);"></path>
                <path d="M24.6183 0C28.7807 0 30.862 0.000553673 32.5426 0.56108C35.7979 1.64713 38.3529 4.20208 39.4389 7.45739C39.9994 9.13798 40 11.2193 40 15.3817V20.016H27.5089L36.5181 16.1861L33.8459 14.4123L25.1048 17.7876L29.2081 12.358L26.2571 11.5501L21.7259 16.6282L21.3885 10.9091H18.3825L18.0398 16.6282L13.5121 11.5501L10.5629 12.358L14.6609 17.7859L5.92507 14.4123L3.25284 16.1861L12.2603 20.016H0V15.3817C0 11.2193 0.000553673 9.13798 0.56108 7.45739C1.64713 4.20208 4.20208 1.64713 7.45739 0.56108C9.13798 0.000553673 11.2193 0 15.3817 0H24.6183Z" fill="#FF1616" data-darkreader-inline-fill="" className="--darkreader-inline-fill: var(--darkreader-background-ff1616, #ff0000);"></path>
            </svg>
        </div>
    );
}
